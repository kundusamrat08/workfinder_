...
if (!isset($_SESSION['email'])) {
    header("Location: employee_login.php"); // Redirect to login page if not logged in
    exit();
}

// Check if profile picture path is set in session and not empty
$host = "localhost"; // Replace with your database host
$username = "root";   // Replace with your database username
$password = "";   // Replace with your database password
$database = "data_research";   // Replace with your database name
...
$query = "SELECT profilePicture FROM jobseeker WHERE js_email = '$email'";
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="index.php" style="font-size: 44px;">workFinder</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav">
                <li class="nav-item active"><a href="employee_homepage.php" class="nav-link" style="font-size: 22px;">Home</a></li>
                <li class="nav-item"><a href="about.html" class="nav-link" style="font-size: 22px;">About</a></li>
                <li class="nav-item"><a href="contact.html" class="nav-link" style="font-size: 22px;">Contact</a></li>
                <li class="nav-item"><a href="jobseeker_profile_update.php" class="nav-link" style="font-size: 22px;">Profile</a></li>
                <li class="nav-item cta"><a href="employee_logout.php" class="nav-link">Log out</a></li>
                <!-- <a href="employee_logout.php" ><button>logout</button></a> -->
                <!-- <a href="employee_logout.php" class="btn-primary">Logout</a> -->

            </ul>

            <ul class="navbar-nav ml-auto">
    <li class="welcome-profile">
...
echo '</tr>';
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            // echo "<td><a href='apply.php?job_id={$row['id']}'>Apply</a></td>";
                            echo "<td><a href='apply.php?job_id={$row['id']}' style='background-color: #0074d9; color: #fff; padding: 5px 10px; text-decoration: none; border-radius: 5px; display: inline-block;'>Apply</a></td>";
...
<section class="ftco-section services-section" style="background-image: url('images/white.jpg'); background-size: 100% auto;">
      <div class="container">
